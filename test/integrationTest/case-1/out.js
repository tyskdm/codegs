require('module').define('core/core/core.js',
function (exports, require, module, __filename, __dirname) {
module.exports = __filename + ' : ' + __dirname;

});
require('module').define('core/core/package.json',
{
  "name": "codegs",
  "version": "0.0.4",
  "description": "Tool to pack Node.js module files and module system emulator within one source file.",
  "repository": {
    "type": "git",
    "url": "https://github.com/tyskdm/codegs.git"
  },
  "author": {
...
require('module').define('node_core/node_core.js',
function (exports, require, module, __filename, __dirname) {
module.exports = __filename + ' : ' + __dirname;
});
require('module').define('/node_modules/mod/mod.js',
function (exports, require, module, __filename, __dirname) {

});
require('module').define('/node_modules/node_modules.js',
function (exports, require, module, __filename, __dirname) {
module.exports = __filename + ' : ' + __dirname;
});
require('module').define('/lib/sub.js',
function (exports, require, module, __filename, __dirname) {
module.exports = __filename + ' : ' + __dirname;
});
require('module').runMain('/lib/main.js');


var core = require('core');
var node_core = require('node_core');
var node_modules = require('node_modules');
...
require('module').endMain('/lib/main.js');
/**
 * module.js
 */
