...
function require(path) {
    ...
    require = (function () {
        ...
        Module._resolveFilename = function (request, parent) {
            ...
            if (Module._isNativeModule(request)) {
                return Module._getNativeModuleName(request);
            }
        ...
        Module._isNativeModule = function (request) {
            return (request === 'module') ||
                   (Module._files['node_core/' + request] !== undefined);
        };

        Module._getNativeModuleName = function (request) {
            return (request === 'module' ? 'module' : Module._files['node_core/' + request]);
        };
        ...
        Module._NativeModule = {
            ...
            exists: function (request) {
                var paths = Module._NativeModule.filePaths;
            ...
            getObject: function (request) {
                ...
                return (gloval[request] !== undefined ? gloval[request] : null);
            }
        };
